...
public interface StatementTree extends Tree{
    ...
    static StatementTree resolveBlockStatement(JavaTokenManager src) throws ParsingException{
    ...
    static StatementTree parse(JavaTokenManager src) throws ParsingException{
    ...
    static StatementTree resolveStatementWithoutTrailingSubstatement(JavaTokenManager src) throws ParsingException{
    ...
    static StatementTree resolveForLoop(JavaTokenManager src) throws ParsingException{
